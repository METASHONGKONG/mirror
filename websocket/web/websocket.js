window.onload = init;
//var socket = new WebSocket("ws://115.160.160.214/websocket/actions");
var socket = new WebSocket("ws://183.179.95.72/websocket/actions");
...
function onMessage(event) {
    ...
    if (device.action === "input") {
        ...
        statusText.innerHTML = "Comments: " + device.description;
